		...
		$.getJSON(urlFull, function(data) {
			...
			for (var i in data) {
				...
				if (data[i][curr_dayOfWeek][curr_hourMin]==0) { 
					...
					// outputString+="<a href=\"javascript:function showRm(){document.getElementById('room').value="+data[i].roomNumber+";document.getElementById('dayOfWeek').value=\""+curr_dayOfWeek+"\";} showRm();";
